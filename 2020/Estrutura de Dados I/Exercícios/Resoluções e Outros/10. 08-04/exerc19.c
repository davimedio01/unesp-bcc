...
/*
19. Duas árvores binárias são espelho-similares (mirror similar) se elas são vazias ou as subárvores
esquerdas de cada uma são espelho-similares as subárvores direita da outra. Escreva um programa para
determinar se duas árvores binárias são espelho similares.
*/
...
int verificaArvoresEspelhoSimilares(def_arvore arvore1, def_arvore arvore2);
...
//Exercício 19
//Verificação de Árvores Espelhos-Similares
int verificaArvoresEspelhoSimilares(def_arvore arvore1, def_arvore arvore2)
{
     //Se forem nulas
     ...
     if (arvore1 != NULL && arvore2 != NULL)
     {
          ...
          if (arvore1->info == arvore2->info)
          {
               ...
               if (verificaArvoresEspelhoSimilares(arvore1->esq, arvore2->dir) &&
                   verificaArvoresEspelhoSimilares(arvore1->dir, arvore2->esq))
                    return 1;
               else
                    return 0;
          }
...
int main()
{
     ...
     //Exercício 19: Verificar se são espelho-similares
     if (verificaArvoresEspelhoSimilares(arvore1, arvore2))
     {
          printf("\nAs arvores sao espelho-similares!\n\n");
     }
     else
     {
          printf("\nAs arvores nao sao espelho-similares.\n\n");
     }
